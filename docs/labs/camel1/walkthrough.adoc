...
If you don't have yet your OpenShift Console open in a tab, follow the actions below from _VS Code_

. At the top of your screen in VS Code you'll find a search bar. +
...
----
.. Then, click in the search bar at the top of your VS Code window
.. Paste the command (linux: kbd:[Ctrl+v], mac: kbd:[⌘+v]) and press kbd:[Enter]
